...
const noticeRetriever = async (url) => {
    ...
    for (let i = 0; i < maxResults; i++) {
        result.push({
            ...
            font: (_a = res.rss.channel) === null || _a === void 0 ? void 0 : _a.link,
            description: res.rss.channel.item[i].description,
            image: (_e = (_c = (_b = res.rss.channel.item[i].enclosure) === null || _b === void 0 ? void 0 : _b.$.url) !== null && _c !== void 0 ? _c : (_d = res.rss.channel.item[i]['media:content']) === null || _d === void 0 ? void 0 : _d.$.url) !== null && _e !== void 0 ? _e : 'https://www.webempresa.com/foro/wp-content/uploads/wpforo/attachments/3200/318277=80538-Sin_imagen_disponible.jpg',
